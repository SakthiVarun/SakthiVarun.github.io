...
import figma_png from "./images/figma.png";

// import footer_bg_dark from "./images/footer-bg-dark.png";
// import footer_bgfrom from "./images/footer-bg.png";
// import hero_bg_dark from "./images/hero-bg-img-dark.png";
// import hero_bg from "./images/hero-bg-img.png";
import hero_man_dark from "./images/hero-man-dark.png";
import hero_man from "./images/hero-man.png";
// import logo_png from "./images/logo.png";
import photoshop_logo from "./images/photoshop-logo.png";
import somelogo_light from "./images/somelogo-light.png";
import somelogo_dark from "./images/somelogo-dark.png";
import project_1 from "./images/project-1.png";
import project_1_big from "./images/project-1-big.png";
  ...
  return (
    <>
      ...
      <div className="fixed ltr:right-0 rtl:left-0 top-[50%] translate-y-[-50%] z-50">
        <button
          className="dark--version bg-accent1 w-[50px] h-[50px] text-white flex justify-center items-center rounded-lg ltr:rounded-tr-none ltr:rounded-br-none rtl:rounded-tl-none rtl:rounded-bl-none"
          id="light__to--dark"
        >
          <svg
        ...
        <div className="header__sticky py-5">
          <div className="container mx-auto">
            <div className="flex justify-between items-center">
              <div className="logo">
                <a href="./index.html">
                  <img className="hidden dark:block" src={logo_light} alt="" />
      ...
      <main>
          ...
          <div className="container mx-auto flex sm:flex-col items-center justify-center lg:mt-[40px] only-md:mt-[40px] sm:pt-[100px] sm:pb-[70px]">
            <div className="lg:max-w-[40%] sm:max-w-[60%] xs:max-w-[85%] only-md:max-w-[40%] flex justify-end">
              <div className="relative only-xl:max-w-[70%]">
                <img className="hidden dark:block" src={hero_man_dark} alt="" />
                <img className="dark:hidden" src={hero_man} alt="" />
            ...
            <div className="ltr:xl:pl-[95px] ltr:lg:pl-[50px] ltr:only-md:pl-[40px] rtl:xl:pr-[95px] rtl:lg:pr-[50px] rtl:only-md:pr-[40px] flex-grow sm:mt-[30px] sm:text-center">
              <span className="text-accent1 text-[24px] font-semibold italic pb-[5px]">
                HELLO I'M
              </span>
              <h2 className="lg:text-[60px] only-md:text-[40px] sm:text-[28px] font-bold font-heebo text-heading dark:text-white">
                Sakthi Varun{" "}
              </h2>
              <h3 className="font-heebo font-normal text-primary dark:text-white">
                Web Developer, Servicenow Developer{" "}
              </h3>
              <p className="lg:text-[20px] md:text-[16px] text-paragraph dark:text-slate-200 lg:mt-[18px] md:mt-[15px]">
                There are many variations of sum availabled <br />
                in alley of type and scrambled it some.
              </p>
              <div className="flex items-center gap-[18px] flex-wrap mt-[30px] sm:justify-center">
                ...
                <div className="flex items-center flex-wrap gap-[15px] sm:justify-center">
                  ...
                  <div className="flex items-center">
                    <a
                      href="google.com"
                      className="w-[30px] h-[30px] flex items-center justify-center text-accent1 border border-accent1 transition duration-300 hover:bg-accent1 hover:text-white rounded-full"
                    >
                      <svg
                        fill="currentColor"
                        stroke="currentColor"
                    ...
                    <a
                      href="google.com"
                      className="w-[30px] h-[30px] flex items-center justify-center text-accent1 border border-accent1 transition duration-300 hover:bg-accent1 hover:text-white rounded-full ltr:ml-[10px] rtl:mr-[10px]"
                    >
                      <svg
                        fill="currentColor"
                        stroke="currentColor"
        ...
        <section className="py-[70px] lg:py-[100px] border-b-[1px] border-[#DDDDDD] dark:border-dark_accent1">
          <div className="container mx-auto">
            <div className="relative">
              <div className="w-full absolute h-[1px] bg-[#DDDDDD] top-[50%] translate-y-[-50%] ltr:left-0 rtl:right-0 2xs:hidden" />
              <div className="flex flex-wrap">
                <div className="max-w-[25%] 2xs:max-w-[50%] w-full ltr:border-r-[1px] rtl:border-l-[1px] border-[#DDDDDD] dark:border-dark_accent1 client__logo--padding">
                  <div className="w-full client__logo--padding--inner 2xs:border-b-[1px] 2xs:border-[#DDDDDD] dark:2xs:border-dark_accent1">
                    <img
                      className="mx-auto opacity-[0.7] hover:opacity-[1] transition duration-300 dark:hidden"
                      src={somelogo_light}
                      alt=""
                    />
                    <img
                      className="mx-auto grayscale hover:grayscale-0 transition duration-300 dark:block hidden"
                      src={somelogo_dark}
                      alt=""
                    />
                  </div>
                  <div className="w-full client__logo--padding--inner 2xs:border-b-[1px] 2xs:border-[#DDDDDD] dark:2xs:border-dark_accent1">
                    ...
                    <img
                      className="mx-auto grayscale hover:grayscale-0 transition duration-300 dark:block hidden"
                      src="./images/logo/dark-log-2.png"
                      alt=""
                    />
                  </div>
                </div>
                <div className="max-w-[25%] 2xs:max-w-[50%] w-full ltr:border-r-[1px] rtl:border-l 2xs:border-none border-[#DDDDDD] dark:border-dark_accent1 client__logo--padding">
                  <div className="w-full client__logo--padding--inner 2xs:border-b-[1px] 2xs:border-[#DDDDDD] dark:2xs:border-dark_accent1">
                    <img
                      className="mx-auto opacity-[0.7] hover:opacity-[1] transition duration-300 dark:hidden"
                    ...
                    <img
                      className="mx-auto grayscale hover:grayscale-0 transition duration-300 dark:block hidden"
                      src="./images/logo/dark-log-3.png"
                      alt=""
                    />
                  </div>
                  <div className="w-full client__logo--padding--inner 2xs:border-b-[1px] 2xs:border-[#DDDDDD] dark:2xs:border-dark_accent1">
                    ...
                    <img
                      className="mx-auto grayscale hover:grayscale-0 transition duration-300 dark:block hidden"
                      src="./images/logo/dark-log-4.png"
                      alt=""
                    />
                  </div>
                </div>
                <div className="max-w-[25%] 2xs:max-w-[50%] w-full ltr:border-r-[1px] rtl:border-l border-[#DDDDDD] client__logo--padding dark:border-dark_accent1">
                  <div className="w-full client__logo--padding--inner 2xs:border-b-[1px] 2xs:border-[#DDDDDD] dark:2xs:border-dark_accent1">
                    <img
                      className="mx-auto opacity-[0.7] hover:opacity-[1] transition duration-300 dark:hidden"
                    ...
                    <img
                      className="mx-auto grayscale hover:grayscale-0 transition duration-300 dark:block hidden"
                      src="./images/logo/dark-log-5.png"
                      alt=""
                    />
                  </div>
                  <div className="w-full client__logo--padding--inner">
                    <img
                      className="mx-auto opacity-[0.7] hover:opacity-[1] transition duration-300 dark:hidden"
                    ...
                    <img
                      className="mx-auto grayscale hover:grayscale-0 transition duration-300 dark:block hidden"
                      src="./images/logo/dark-log-6.png"
                      alt=""
                    />
                  </div>
                </div>
                <div className="max-w-[25%] 2xs:max-w-[50%] w-full client__logo--padding">
                  <div className="w-full client__logo--padding--inner 2xs:border-b-[1px] 2xs:border-[#DDDDDD] dark:2xs:border-dark_accent1">
                    <img
                      className="mx-auto opacity-[0.7] hover:opacity-[1] transition duration-300 dark:hidden"
                    ...
                    <img
                      className="mx-auto grayscale hover:grayscale-0 transition duration-300 dark:block hidden"
                      src="./images/logo/dark-log-7.png"
                      alt=""
                    />
                  </div>
                  <div className="w-full client__logo--padding--inner">
                    ...
                    <img
                      className="mx-auto grayscale hover:grayscale-0 transition duration-300 dark:block hidden"
                      src="./images/logo/dark-log-8.png"
                      alt=""
                    />
                  </div>
                </div>
        ...
        <section className="lg:pb-[100px] md:pb-[70px]">
          <div className="container mx-auto">
            ...
            <div className="flex justify-between items-center gap-[20px] lg:gap-[30px] mb-[55px] md:flex-wrap md:text-center">
              ...
              <div className="md:grow">
                <p className="text-[#636363] dark:text-slate-200 text-[17px] leading-[28px] lg:max-w-[472px] w-full">
                  Promote your skills, case studies, and product ouncems with
                  the the branded videoscustomers coming back for services Makes
                  best effort.
                </p>
              </div>
              ...
              <div className="portfolio__grid flex mt-[50px] mx-[-15px]">
                ...
                >
                  <div className="relative overflow-hidden">
                    <a href="google.com" className="popup-modal--open">
                      <span className="absolute w-full h-full bg-accent1 left-0 top-0 opacity-0 transition duration-300 portfolio__overlay z-10">
                        <div className="flex items-center justify-end flex-col text-center h-full text-white p-[20px]">
                          ...
                          <span className="portfolio--sub-title text-[17px] 2xs:hidden transition-all duration-500 translate-y-3">
                            Promote your blog posts, case udie, and thehe
                            branded videos.
                          </span>
                        </div>
                      </span>
                      ...
                      <div className="modal__portfolio--content relative z-10 h-full flex items-center px-[15px] max-w-[750px] xl:max-w-[800px] mx-auto transition duration-300 translate-y-[-50px]">
                        <div className="overflow-y-auto modal__portfolio--content-inner bg-white dark:bg-gray-800  max-h-[60vh] lg:max-h-[80vh] p-8 rounded-2xl relative">
                          ...
                          <p className="dark:text-white font-normal text-[17px]">
                            ...
                            blanditiis pariatur labore explicabo quo repellat
                            hic dolorum numquam asperiores, voluptatum fugiat
        ...
        <section className="lg:py-[100px] md:py-[70px] dark:border-b dark:border-dark_accent1">
          <div className="container mx-auto">
            {/* Section title start */}
            <div className="mb-[35px] lg:mb-[55px]">
              <div className="max-w-full max-w-full w-full text-center">
                <span className="text-accent1 text-[20px] lg:text-[24px] font-medium mb-[10px] lg:mb-[5px]">
                  TESTIMONIALS
                </span>
                <h2 className="text:[28px] lg:text-[48px] font-bold font-heebo leading-[36x] lg:leading-[58px] text-[#000248] dark:text-white">
            ...
            {/* Section title end */}
            <div className="testimonial__slider--inner lg:px-[220px] relative">
              ...
              <div className="swiper testimonial__slider">
                ...
                <div className="swiper-wrapper">
                  ...
                  <div className="swiper-slide">
                    <div className="slider__inner text-center">
                      <div className="client__rating flex justify-center gap-[5px]">
                        <span>
                          <svg
                            className="fill-[#ffce31] stroke-[#ffce31]"
                            xmlns="http://www.w3.org/2000/svg"
                            width={20}
                            height={28}
                            viewBox="0 0 24 24"
                      ...
                      <div className="text-[24px] leading-8 text-paragraph dark:text-slate-200 italic mt-[20px] mb-[30px]">
                      ...
                      <div>
                        <img
                          className="mx-auto w-[130px] h-[130px] rounded-full shadow-[0_0_50px_0_rgba(196,206,213,0.2)]"
                          src={testimonial}
                          alt=""
                        />
                        <div className="mt-[25px]">
                          <h3 className="text-2xl text-primary dark:text-white">
                            Romes Barson
                          </h3>
                          <span className="dark:text-slate-100">Manager</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="swiper-pagination mt-7" />
              </div>
              <div className="md:hidden">
                <span className="absolute top-[38%] translate-y-[-50%] left-0 xl:left-[-12%] only-xl:left-[0]  text-accent1">
                  <svg
                    className="w-full only-lg:max-w-[130px] only-xl:max-w-[150px] xl:max-w-[250px] opacity-30"
                    fill="currentColor"
                    stroke="currentColor"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512"
                ...
                <span className="absolute top-[38%] translate-y-[-50%] right-0 xl:right-[-12%] only-xl:right-[0] text-accent1">
                  <svg
                    className="w-full only-lg:max-w-[130px] only-xl:max-w-[150px] xl:max-w-[250px] opacity-30"
                    fill="currentColor"
                    stroke="currentColor"
        ...
        <section
          className="py-[70px] lg:py-[100px] mb-[270px] bg-cover bg-no-repeat bg-center bg-[url('../images/contact-bg.png')] bg-[#ECF1F6] dark:bg-[url('../images/contact-bg-dark.png')] dark:bg-dark_primary_bg"
          id="contact"
        >
          <div className="container mx-auto">
            {/* Form wrapper start */}
            ...
            <div className="mb-[-275px] pt-[70px] lg:pt-[100px]">
              <div style={{ width: "100%" }}>
                <iframe
                  ...
                  marginWidth={0}
                  title="google maps"
                  src="https://maps.google.com/maps?width=100%25&height=440&hl=en&q=1%20Grafton%20Street,%20Dublin,%20Ireland+(My%20Business%20Name)&t=&z=14&ie=UTF8&iwloc=B&output=embed"
                >
                  &lt;a
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 only-md:grid-cols-2 lg:grid-cols-3 gap-[30px]">
              ...
              <div className="blog__card shadow-[0_0_50px_0_rgba(196,206,213,0.2)] hover:shadow-[0_0_100px_0_rgba(196,206,213,0.7)] dark:shadow-[0_0_20px_0_rgba(0,0,0,0.1)] dark:hover:shadow-[0_0_50px_0_rgba(0,0,0,0.2)] transition duration-500">
                <a className="block popup-modal--open" href="google.com">
                  {/* blog image */}
                      ...
                      <div>
                        ...
                        <div className="blog__content mt-5 text-[17px] leading-7 dark:text-slate-300">
                          <p>
                            ...
                            distribution of letters, as opposed to using ique
                            maiestatis sum quod sum ut alienum nec et to summo
                            possim persequeris vix mea. Adhuc quodsi qui, sit no
                            tale essent electramei sum sums rodesset in pro, quo
                            scripta feugait vidisse. Lorem ipsum dolor sit amet,
                            eu duo ferri labor dicat Mea ex modo reque senserit,
                            et sed hinc dolor, scaevola sum salutandi expetendis
                            vix ne his quod mundi consequat sum. There are not
                            many of passages of lorem{" "}
                          </p>
                          <p className="mt-5">
                            It is a long established fact that a reader will be
                            distracted by the readable content of a page is when
              ...
              {/* single blog  start */}
              <div className="blog__card shadow-[0_0_50px_0_rgba(196,206,213,0.2)] hover:shadow-[0_0_100px_0_rgba(196,206,213,0.7)] dark:shadow-[0_0_20px_0_rgba(0,0,0,0.1)] dark:hover:shadow-[0_0_50px_0_rgba(0,0,0,0.2)] transition duration-500">
                <div className="block popup-modal--open">
                  {/* blog image */}
                  <div className="overflow-hidden">
                    <span className="block">
                      <img
      ...
      {/* Main wrapper end */}
      {/* Footer start */}
      <footer className="py-[50px] bg-cover bg-no-repeat bg-center bg-[url('../images/footer-bg.png')] bg-[#EFF3F7] dark:bg-[url('../images/footer-bg-dark.png')] dark:bg-dark_primary_bg dark:border-t dark:border-dark_accent1">
        <div className="container mx-auto">
            ...
            <div className="flex">
              <p className="flex items-center flex-wrap sm:justify-center dark:text-slate-200">
                ...
                <span className=" px-[3px]">
                  <a className="text-accent1 hover:font-bold" href="google.com">
                    Benos
                  </a>
                </span>
                © 2023
